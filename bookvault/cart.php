                ...
                ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button style="background:transparent; color:green" name="update"><img style="height: 26px; cursor:pointer;" src="./images/update1.png" alt="update"> Update</button> | 
                                <a style="color: red;" href="cart.php?remove=<?php echo $row['id'];?>"><img style="height: 26px; cursor:pointer;" > Remove</a>
                                </form>
