...
if (isset($_POST['update_user'])) {
    ...
    mysqli_query($conn, "UPDATE `users_info` SET name = '$update_name', email ='$update_email', user_type='$update_user_type' WHERE Id = '$update_id'") or die('query failed');  //password = '$update_password'
...
<body>
   ...
   <?php
      $select_user = mysqli_query($conn, "SELECT Id,name,email,user_type FROM users_info") or die('query failed'); //password
   ...
   <!-- <div class="box">
    ...
    <!-- deleting and updating user and admin -->
   <?php if ($fetch_user['user_type'] == 'Admin') { ?>
   <div class="box">
    <div class="name">User ID: <?php echo $fetch_user['Id']; ?></div>
    <div class="name">Name: <?php echo $fetch_user['name']; ?>&nbsp;</div>
    <div class="name">Email ID: <?php echo $fetch_user['email']; ?></div>
    <!-- <div class="password">Password: <?php echo $fetch_user['password']; ?></div> -->
    <?php
    $user_type_color = ($fetch_user['user_type'] == 'Admin') ? 'red' : 'blue';
    ?>
    <div class="price" style="color: <?php echo $user_type_color; ?>">User type: <?php echo $fetch_user['user_type']; ?></div>
    <a style="color:rgb(255, 187, 0);" href="users_detail.php?update_user=<?php echo $fetch_user['Id']; ?>">Update</a>
</div>
